...
export default function WhereWeWork({ data, sectionId, dataIndex }) {
          ...
          >
            ...
            {editingIndex === 4 ? (
              <div className="editable-container">
                ...
                />
                <div className="editable-buttons">
                  <button className="save-btn" onClick={() => handleSave(4)}>
                    Save Changes
                  </button>
                  <button className="cancel-btn" onClick={handleCancel}>
                    Cancel
              ...
              <>
                <p>
                  ...
                  {isAuthorized && (
                    <button
                      className="edit-btn"
                      onClick={() => handleEditClick(4, paragraphs[4].p)}
                    >
                      <EditIcon className="edit-btn-icon" />
                    </button>
                  )}
